...
export class DriverLicenseInfoController {
  constructor(private readonly driverLicenseInfoService: DriverLicenseInfoService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateDriverLicenseInfoDto: UpdateDriverLicenseInfoDto) {
