  ...
  async extractVehicleRegistration(
    ...
    try {
      const systemPrompt = `
        ...
        Analyse le texte brut fourni par l'OCR et extrait uniquement les informations suivantes au format JSON:
        - plateNumber: numéro d'immatriculation (Tout en majuscule sans espaces mais si tu trouves les tirets ou autres séparateurs, garde les tels quels) Exemple: 1234 AB 01 = 1234AB01 ou 1234AB01 = 1234AB01 ou AA-123-AA = AA-123-AA 
