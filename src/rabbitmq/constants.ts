...
export const CREATE_YANGO_PROFILE_SENT_QUEUE_NAME = 'create-yango-profile-sent-queue'
export const CREATE_YANGO_CAR_SENT_QUEUE_NAME = 'create-yango-car-sent-queue'
export const UPDATE_YANGO_DRIVER_INFO_SENT_QUEUE_NAME = 'update-yango-driver-info-sent-queue'
